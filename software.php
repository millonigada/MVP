  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="#" class="list-group-item list-group-item-action bg-light">App Development</a>
        <a href="#" class="list-group-item list-group-item-action bg-light">Web Development</a>
        <a href="#" class="list-group-item list-group-item-action bg-light">Artificial Intelligence</a>
        <a href="#" class="list-group-item list-group-item-action bg-light">Machine Learning</a>
        <a href="#" class="list-group-item list-group-item-action bg-light">Deep Learning</a>
        <a href="#" class="list-group-item list-group-item-action bg-light">Version Control</a>
      </div>
    </div>
    <!-- /#sidebar-wrapper -->
